...
# --------------------------------------------------------------------------
# Normalise MetaSequin counts based on Captors
# --------------------------------------------------------------------------
...
# Load dataframes of counts for captors and MetaSequins
captors <- read.csv("Captor_coverge_by_sample.csv", header = TRUE, row.names = 1)
metaseqins <- read.csv("Metasequin_coverge_by_sample.csv", header = TRUE, row.names = 1)
total_counts <- round(rbind(captors, metaseqins))

write.csv(total_counts, "Captor_Metasequin_coverge_by_sample.csv", row.names = FALSE)

# Plot samples before normalisation
# --------------------------------------------------------------------------

# Create sample design matrix (experiment specific)
